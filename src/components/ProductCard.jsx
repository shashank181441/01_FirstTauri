...
function ProductCard({ product, myCart }) {
  ...
  return (
    <div className="group">
      <div className="relative aspect-h-1 aspect-w-1 w-full h-64 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
